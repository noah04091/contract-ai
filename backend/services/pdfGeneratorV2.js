...
const createCorporateStyles = (theme) => {
  const c = theme.colors;
  return StyleSheet.create({
    // WICHTIG: Explizit weißer Hintergrund und dunkle Textfarbe für alle Seiten
    ...
    // Content Styles - WICHTIG: Weißer Hintergrund und dunkle Textfarbe!
    contentPage: { flex: 1, backgroundColor: '#ffffff' },
    contentMain: { padding: 40, paddingTop: 30, backgroundColor: '#ffffff' },
    preambleContainer: { marginBottom: 25, backgroundColor: '#f0f4f8', padding: 15, borderLeftWidth: 3, borderLeftColor: c.primary },
