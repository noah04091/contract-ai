...
const createModernStyles = (theme) => {
  ...
  return StyleSheet.create({
    ...
    sectionHeader: { fontSize: 13, fontWeight: 'bold', color: c.primary, marginTop: 25, marginBottom: 12, backgroundColor: '#F9FAFB', padding: 8, marginLeft: -8 },
...
const createCorporateStyles = (theme) => {
  const c = theme.colors;
  return StyleSheet.create({
    page: { fontFamily: theme.fontFamily, fontSize: 10, padding: 50, color: c.text },
    coverPage: { paddingBottom: 40, lineHeight: 1.4 },
    headerBar: { backgroundColor: c.primary, padding: 15, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    ...
    titleContainer: { alignItems: 'center', marginTop: 30, marginBottom: 25, backgroundColor: c.primary, padding: 20 },
    ...
    partiesLabel: { fontSize: 8, color: c.primary, fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 8 },
    partyBox: { borderWidth: 1, borderColor: c.primary, marginBottom: 10 },
    partyBoxHeader: { padding: 6, borderBottomWidth: 1, borderBottomColor: c.primary },
    partyBoxContent: { padding: 10 },
    partyName: { fontSize: 10, fontWeight: 'bold', color: c.primary },
    partyAddress: { fontSize: 8, color: c.textLight },
    partyRole: { fontSize: 7, color: c.accent, fontWeight: 'bold' },
    footer: { position: 'absolute', bottom: 30, left: 50, right: 50, flexDirection: 'row', justifyContent: 'space-between', fontSize: 8, color: c.textMuted, borderTopWidth: 1, borderTopColor: c.primary, paddingTop: 10 },
    contentPage: { paddingBottom: 0, lineHeight: 1.5 },
    contentMain: { flex: 1 },
    preambleContainer: { marginBottom: 20, paddingBottom: 15, borderBottomWidth: 1, borderBottomColor: c.primary },
    ...
    sectionHeader: { fontSize: 12, fontWeight: 'bold', color: c.primary, marginTop: 20, marginBottom: 10, paddingBottom: 5, borderBottomWidth: 1, borderBottomColor: c.primary },
    ...
    pageFooter: { position: 'absolute', bottom: 30, left: 50, right: 50, flexDirection: 'row', justifyContent: 'space-between', fontSize: 8, color: c.textMuted, borderTopWidth: 1, borderTopColor: c.primary, paddingTop: 8 },
    signaturePage: { paddingBottom: 60, lineHeight: 1.5 },
    ...
    signatureColumns: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 30 },
    signatureColumn: { width: '45%', borderWidth: 1, borderColor: c.primary, padding: 15 },
    ...
    signatureLine: { borderBottomWidth: 1, borderBottomColor: c.textLight, marginBottom: 5 },
    signatureHint: { fontSize: 7, color: c.textMuted },
    signatureName: { fontSize: 9, fontWeight: 'bold', marginTop: 15, color: c.text },
    signatureRole: { fontSize: 7, color: c.textMuted },
    verificationContainer: { alignItems: 'center', marginTop: 50, padding: 15, borderTopWidth: 1, borderTopColor: c.primary },
    qrCode: { width: 50, height: 50 },
    verificationText: { fontSize: 6, color: c.textMuted, marginTop: 5 },
    attachmentsBox: { marginTop: 30, borderWidth: 1, borderColor: c.primary },
    attachmentsHeader: { padding: 8, borderBottomWidth: 1, borderBottomColor: c.primary },
