...
const translations = {
  de: {
    ...
    "error.truncationWarning": "Sehr langer Vertrag — analysiert und überwacht wird der erste Teil des Dokuments",
  ...
  en: {
    ...
    "error.truncationWarning": "Very long contract — the first part of the document is analyzed and monitored",
