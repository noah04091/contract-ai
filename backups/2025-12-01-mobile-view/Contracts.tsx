              ...
              >
                ...
                {loading && !refreshing ? (
                  ...
                  <>
                    ...
                    {/* viewMode wird als CSS-Klasse übergeben für Grid/List-Darstellung */}
                    <div className={`${styles.mobileCardsContainer} ${viewMode === 'grid' ? styles.mobileGridView : styles.mobileListView}`}>
                      {displayedContracts.map((contract) => (
                        <MobileContractCard
