...
export const legalTerms: LegalTerm[] = [
  ...
  },
  {
    ...
    relatedTerms: ['wettbewerbsverbot'],
  ...
  // =============================================
  // ERWEITERUNG (verankert an verifizierten §§ aus legalLensSources)
  // =============================================
  {
    id: 'arbeitsvertrag',
    term: 'Arbeitsvertrag',
    simpleExplanation: 'Der Vertrag, mit dem sich jemand verpflichtet, für einen Arbeitgeber weisungsgebundene Arbeit zu leisten - gegen Lohn.',
    legalDefinition: 'Durch den Arbeitsvertrag verpflichtet sich der Arbeitnehmer zur Leistung weisungsgebundener, fremdbestimmter Arbeit in persönlicher Abhängigkeit; der Arbeitgeber zur Zahlung der vereinbarten Vergütung. Ob ein Arbeitsvertrag vorliegt, richtet sich nach der tatsächlichen Durchführung, nicht nach der Bezeichnung im Vertrag.',
    examples: ['Im Arbeitsvertrag wurden 40 Wochenstunden und ein Bruttomonatsgehalt vereinbart', 'Obwohl der Vertrag "freier Mitarbeiter" hieß, lag wegen Weisungsgebundenheit tatsächlich ein Arbeitsvertrag vor'],
    relatedTerms: ['kuendigung', 'probezeit', 'aufhebungsvertrag'],
    legalArea: 'arbeitsrecht',
    legalBasis: '§ 611a BGB',
    letterGroup: 'A',
  },
  {
    id: 'verbraucher',
    term: 'Verbraucher',
    simpleExplanation: 'Eine Privatperson, die etwas zu privaten Zwecken kauft oder vereinbart - nicht für ihr Geschäft oder ihren Beruf.',
    legalDefinition: 'Verbraucher ist jede natürliche Person, die ein Rechtsgeschäft zu Zwecken abschließt, die überwiegend weder ihrer gewerblichen noch ihrer selbständigen beruflichen Tätigkeit zugerechnet werden können.',
    examples: ['Wer privat online ein Möbelstück bestellt, handelt als Verbraucher und genießt das Widerrufsrecht', 'Ein Selbstständiger, der einen Laptop überwiegend für die Firma kauft, ist kein Verbraucher'],
    relatedTerms: ['fernabsatz', 'agb', 'vertrag'],
    legalArea: 'vertragsrecht',
    legalBasis: '§ 13 BGB',
    letterGroup: 'V',
  },
  {
    id: 'vertrag',
    term: 'Vertrag',
    simpleExplanation: 'Eine rechtlich bindende Einigung zwischen zwei oder mehr Parteien - entsteht durch Angebot und Annahme.',
    legalDefinition: 'Zur Begründung oder Änderung eines Schuldverhältnisses durch Rechtsgeschäft ist grundsätzlich ein Vertrag zwischen den Beteiligten erforderlich (§ 311 Abs. 1 BGB). Wer einem anderen den Abschluss eines Vertrags anträgt, ist an dieses Angebot gebunden (§ 145 BGB).',
    examples: ['Mit der Annahme des schriftlichen Angebots kam der Vertrag wirksam zustande', 'Auch ein mündlich geschlossener Vertrag ist grundsätzlich bindend'],
    relatedTerms: ['willenserklarung', 'anfechtung', 'vertragsfreiheit'],
    legalArea: 'vertragsrecht',
    legalBasis: '§§ 145, 311 BGB',
    letterGroup: 'V',
  },
  {
    id: 'fernabsatz',
    term: 'Fernabsatzvertrag',
    simpleExplanation: 'Ein Vertrag, der komplett aus der Ferne zustande kommt - per Online-Shop, Telefon, E-Mail oder Katalog, ohne dass sich die Parteien persönlich gegenüberstehen.',
    legalDefinition: 'Fernabsatzverträge sind Verträge, bei denen Unternehmer und Verbraucher für die Vertragsverhandlungen und den Vertragsschluss ausschließlich Fernkommunikationsmittel (z. B. Brief, Telefon, E-Mail, SMS, Online-Shop) verwenden, sofern dies im Rahmen eines organisierten Vertriebs- oder Dienstleistungssystems geschieht.',
    examples: ['Eine Bestellung im Online-Shop ist ein Fernabsatzvertrag - der Verbraucher hat regelmäßig ein 14-tägiges Widerrufsrecht', 'Ein telefonisch abgeschlossener Vertrag fällt ebenfalls unter den Fernabsatz'],
    relatedTerms: ['verbraucher', 'agb', 'vertrag'],
    legalArea: 'vertragsrecht',
    legalBasis: '§ 312c BGB',
    letterGroup: 'F',
  },
  {
    id: 'frist',
    term: 'Frist',
    simpleExplanation: 'Ein bestimmter Zeitraum, in dem etwas getan werden muss oder darf - z. B. eine Kündigungs- oder Zahlungsfrist. Das Gesetz regelt genau, wann eine Frist endet.',
    legalDefinition: 'Für Frist- und Terminsbestimmungen in Gesetzen, gerichtlichen Verfügungen und Rechtsgeschäften gelten die Auslegungsvorschriften der §§ 187 bis 193 BGB. Eine nach Tagen bestimmte Frist endet mit Ablauf des letzten Tages; bei Wochen oder Monaten am entsprechend benannten Tag (§ 188 BGB).',
    examples: ['Eine Kündigungsfrist von drei Monaten zum Monatsende muss eingehalten werden', 'Fällt das Fristende auf einen Sonntag oder Feiertag, endet die Frist erst am nächsten Werktag (§ 193 BGB)'],
    relatedTerms: ['kuendigung', 'anspruch'],
    legalArea: 'allgemein',
    legalBasis: '§§ 186-193 BGB',
    letterGroup: 'F',
  },
  {
    id: 'anspruch',
    term: 'Anspruch',
    simpleExplanation: 'Das Recht, von jemand anderem etwas zu verlangen - also dass er etwas tut oder unterlässt (z. B. zahlt oder etwas herausgibt).',
    legalDefinition: 'Anspruch ist das Recht, von einem anderen ein Tun oder Unterlassen zu verlangen (§ 194 Abs. 1 BGB). Ansprüche unterliegen grundsätzlich der Verjährung.',
    examples: ['Der Verkäufer hat gegen den Käufer einen Anspruch auf Zahlung des Kaufpreises', 'Ein Schadensersatzanspruch verjährt regelmäßig nach drei Jahren'],
    relatedTerms: ['frist', 'vertrag'],
    legalArea: 'allgemein',
    legalBasis: '§ 194 BGB',
    letterGroup: 'A',
  },
  {
    id: 'vertretung',
    term: 'Vertretung (Vollmacht)',
    simpleExplanation: 'Wenn jemand im Namen eines anderen handelt - z. B. unterschreibt ein Mitarbeiter für die Firma. Die Erklärung wirkt dann direkt für den Vertretenen.',
    legalDefinition: 'Eine Willenserklärung, die jemand innerhalb der ihm zustehenden Vertretungsmacht im Namen des Vertretenen abgibt, wirkt unmittelbar für und gegen den Vertretenen (§ 164 Abs. 1 BGB). Maßgeblich ist, dass der Wille, in fremdem Namen zu handeln, erkennbar hervortritt.',
    examples: ['Der Prokurist unterschreibt den Vertrag im Namen der GmbH - verpflichtet wird die GmbH, nicht er persönlich', 'Ohne Vertretungsmacht abgeschlossene Geschäfte sind schwebend unwirksam'],
    relatedTerms: ['willenserklarung', 'vertrag'],
    legalArea: 'vertragsrecht',
    legalBasis: '§ 164 BGB',
    letterGroup: 'V',
  },
  {
    id: 'firma',
    term: 'Firma',
    simpleExplanation: 'Der offizielle Name, unter dem ein Kaufmann oder Unternehmen seine Geschäfte führt - nicht das Unternehmen selbst, sondern sein Handelsname.',
    legalDefinition: 'Die Firma eines Kaufmanns ist der Name, unter dem er seine Geschäfte betreibt und die Unterschrift abgibt; unter ihrer Firma kann sie klagen und verklagt werden (§ 17 HGB).',
    examples: ['"Müller Handels GmbH" ist die Firma - also der Handelsname, nicht das Gebäude oder die Belegschaft', 'Die Firma muss zur Kennzeichnung geeignet sein und Unterscheidungskraft besitzen'],
    relatedTerms: ['gesellschaftsvertrag', 'jahresabschluss'],
    legalArea: 'handelsrecht',
    legalBasis: '§ 17 HGB',
    letterGroup: 'F',
  },
  {
    ...
    simpleExplanation: 'Der Vertrag, mit dem mehrere Personen eine Gesellschaft gründen und sich verpflichten, einen gemeinsamen Zweck zu fördern (z. B. eine GbR).',
    legalDefinition: 'Die Gesellschaft wird durch den Abschluss des Gesellschaftsvertrags errichtet, in dem sich die Gesellschafter verpflichten, die Erreichung eines gemeinsamen Zwecks in der durch den Vertrag bestimmten Weise zu fördern (§ 705 Abs. 1 BGB).',
    examples: ['Die drei Gründer regelten Einlagen und Stimmrechte im Gesellschaftsvertrag', 'Der Gesellschaftsvertrag legt den gemeinsamen Zweck der Gesellschaft fest'],
    relatedTerms: ['vertrag', 'firma'],
    legalArea: 'gesellschaftsrecht',
    legalBasis: '§ 705 BGB',
    letterGroup: 'G',
  },
  {
    ...
    simpleExplanation: 'Eine Absicherung, die jemand stellen muss, damit der andere im Streitfall nicht leer ausgeht - z. B. Hinterlegung, Verpfändung oder Bürgschaft.',
    legalDefinition: 'Wer Sicherheit zu leisten hat, kann dies u. a. durch Hinterlegung von Geld oder Wertpapieren, durch Verpfändung oder durch Bestellung von Hypotheken bewirken; ist dies nicht möglich, ist die Stellung eines tauglichen Bürgen zulässig (§ 232 BGB).',
    examples: ['Als Sicherheitsleistung hinterlegte die Partei einen Geldbetrag', 'Statt einer Barkaution wurde eine Bürgschaft als Sicherheit gestellt'],
    relatedTerms: ['vertrag', 'anspruch'],
    legalArea: 'vertragsrecht',
    legalBasis: '§ 232 BGB',
    letterGroup: 'S',
  },
  {
    id: 'quittung',
    term: 'Quittung',
    simpleExplanation: 'Eine schriftliche Bestätigung, dass eine Zahlung oder Leistung empfangen wurde - man hat ein Recht darauf, sie zu verlangen.',
    legalDefinition: 'Der Gläubiger hat gegen Empfang der Leistung auf Verlangen ein schriftliches Empfangsbekenntnis (Quittung) zu erteilen. Hat der Schuldner ein rechtliches Interesse an einer anderen Form, kann er diese verlangen (§ 368 BGB).',
    examples: ['Nach Barzahlung der Miete verlangte der Mieter eine Quittung', 'Die Quittung dient als Nachweis, dass die Schuld beglichen wurde'],
    relatedTerms: ['anspruch'],
    legalArea: 'vertragsrecht',
    legalBasis: '§ 368 BGB',
    letterGroup: 'Q',
  },
  {
    ...
    simpleExplanation: 'Der jährliche "Kassensturz" eines Kaufmanns - Bilanz plus Gewinn- und Verlustrechnung, die zeigen, wie das Unternehmen finanziell dasteht.',
    legalDefinition: 'Der Kaufmann hat zum Schluss jedes Geschäftsjahrs eine Bilanz sowie eine Gegenüberstellung von Aufwendungen und Erträgen (Gewinn- und Verlustrechnung) aufzustellen; beide bilden zusammen den Jahresabschluss (§ 242 HGB). Für sehr kleine Einzelkaufleute (§ 241a HGB) gilt eine Ausnahme.',
    examples: ['Der Steuerberater erstellte den Jahresabschluss für das abgelaufene Geschäftsjahr', 'Bilanz und Gewinn- und Verlustrechnung bilden zusammen den Jahresabschluss'],
    relatedTerms: ['firma'],
    legalArea: 'handelsrecht',
    legalBasis: '§ 242 HGB',
    letterGroup: 'J',
  },
  {
    id: 'obliegenheit',
    term: 'Obliegenheit',
    simpleExplanation: 'Eine Pflicht "light" - man muss sie nicht erfüllen, aber wer sie verletzt, verliert Vorteile (typisch im Versicherungsrecht: Wer Pflichten verletzt, riskiert seinen Versicherungsschutz).',
    legalDefinition: 'Verletzt der Versicherungsnehmer eine vertragliche Obliegenheit, kann der Versicherer bei vorsätzlicher Verletzung leistungsfrei sein und bei grober Fahrlässigkeit seine Leistung in einem der Schwere des Verschuldens entsprechenden Verhältnis kürzen (§ 28 VVG).',
    examples: ['Wer nach einem Unfall den Schaden zu spät meldet, verletzt eine Obliegenheit und riskiert die Kürzung der Versicherungsleistung', 'Im Gegensatz zu einer echten Pflicht kann die Erfüllung einer Obliegenheit nicht eingeklagt werden'],
    relatedTerms: ['anspruch', 'frist'],
    legalArea: 'allgemein',
    legalBasis: '§ 28 VVG',
    letterGroup: 'O',
  },
  {
    ...
    term: 'Geistiges Eigentum (Urheber)',
    simpleExplanation: 'Rechte an geistigen Schöpfungen wie Texten, Musik, Software oder Designs. Grundregel im Urheberrecht: Urheber ist, wer das Werk geschaffen hat.',
    legalDefinition: 'Urheber ist der Schöpfer des Werkes (§ 7 UrhG). Das Urheberrecht entsteht originär beim Schöpfer und schützt persönliche geistige Schöpfungen; es kann nicht übertragen, sondern nur in Form von Nutzungsrechten eingeräumt werden.',
    examples: ['Die Programmiererin ist Urheberin des von ihr geschriebenen Codes', 'Auch ohne Vermerk entsteht das Urheberrecht automatisch mit der Schöpfung des Werkes'],
    relatedTerms: ['vertrag'],
    legalArea: 'allgemein',
    legalBasis: '§ 7 UrhG',
    letterGroup: 'G',
  },
