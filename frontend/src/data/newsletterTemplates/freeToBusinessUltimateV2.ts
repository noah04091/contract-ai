...
Geht den meisten so. Genau deshalb gibt's ${PROMO_PERCENT}% Rabatt mit Code ${PROMO_CODE} &mdash; nur ${PROMO_DAYS} Tage.
</div>
...
export const freeToBusinessUltimateV2Template: NewsletterTemplate = {
  id: 'free-to-business-ultimate-v2',
  label: '⭐ Free → Business · ULTIMATE v2 (Konzern-Niveau)',
  description: 'TOP-EMPFEHLUNG v2. 9.8/10 Potenzial laut KI-Doppel-Review. 3-Spalten-Pricing (Free / Business ⭐ / Enterprise 🚀), Killer-Satz mit Jahresabo-ROI, neutraler CTA "Tarif wählen", echte Enterprise-Features aus subscriptionPlans.js (API, Excel-Export, Outlook/CRM-Integrationen). Personalisierung, Founder-Voice, Loss-Aversion-Anchoring.',
