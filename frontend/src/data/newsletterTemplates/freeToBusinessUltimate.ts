        ...
        <tr>
          <td class="px-inner" style="padding:48px 56px 0;text-align:center;">
            ...
            <h2 class="section-h" style="margin:14px 0 0;font-family:'Playfair Display',Georgia,serif;font-size:30px;line-height:1.28;color:#0f172a;font-weight:700;letter-spacing:-0.4px;">
              Der Unterschied,<br>den du sofort sp&uuml;rst.
            </h2>
          </td>
        </tr>
              ...
              <tr>
                ...
                <td class="compare-cell compare-cell-last" valign="top" style="width:50%;padding:28px 24px;background-color:#eff6ff;">
                  ...
                  <div style="font-family:'Inter',Helvetica,Arial,sans-serif;font-size:13px;color:#1f2937;line-height:1.7;">
                    <span style="color:#3b82f6;font-weight:700;">&#10003;</span>&nbsp; 25 Tiefen-Analysen pro Monat<br>
                    <span style="color:#3b82f6;font-weight:700;">&#10003;</span>&nbsp; Risiken erkennen, bevor sie teuer werden<br>
                    <span style="color:#3b82f6;font-weight:700;">&#10003;</span>&nbsp; Fr&uuml;hwarnung bei Urteilen &amp; Gesetzen<br>
                    <span style="color:#3b82f6;font-weight:700;">&#10003;</span>&nbsp; Fristen automatisch im Kalender
                  </div>
                </td>
              </tr>
            </table>
...
export const freeToBusinessUltimateTemplate: NewsletterTemplate = {
  id: 'free-to-business-ultimate',
  label: '⭐ Free → Business · ULTIMATE (Konzern-Niveau)',
  description: 'TOP-EMPFEHLUNG. Verkaufspsychologisch maximiert: Pattern-Interrupt-Hook + {{firstName}}-Personalisierung + Free-vs-Business-Vergleichstabelle + 3 Feature-Stories + 5 Bonus-USP-Pillen + Founder-Voice + Preis-Anchoring. Scannable für 80% der Leser, emotional für die anderen 20%.',
  subject: '{{firstName}}, wann hast du das letzte Mal einen Vertrag wirklich gelesen?',
  preheader: 'Geht den meisten so. 10% Rabatt für 3 Monate mit Code AKTION10 — nur 7 Tage.',
