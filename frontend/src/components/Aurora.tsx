...
export default function Aurora(props: AuroraProps) {
  ...
  useEffect(() => {
    ...
    const defaultColorStops = ['#0066FF', '#409CFF', '#0052CC'];
    const initialColorStops = propsRef.current.colorStops ?? defaultColorStops;
    ...
    const update = (t: number) => {
      ...
      const stops = propsRef.current.colorStops ?? defaultColorStops;
  ...
  }, []); // Only run once on mount - props are read via ref
