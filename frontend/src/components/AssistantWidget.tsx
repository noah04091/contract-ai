...
export default function AssistantWidget() {
  ...
  return (
    <>
      ...
      {/* Chat Window (mobil: Bottom Sheet über abgedunkelter Seite) */}
      <AnimatePresence>
        {isOpen && (
          <motion.div
            key="chatBackdrop"
        ...
        {isOpen && (
          <motion.div
            ...
            initial={{ opacity: 0, y: isMobile ? 80 : 20, scale: isMobile ? 1 : 0.95 }}
            animate={{ opacity: 1, y: 0, scale: 1 }}
            exit={{ opacity: 0, y: isMobile ? 80 : 20, scale: isMobile ? 1 : 0.95 }}
