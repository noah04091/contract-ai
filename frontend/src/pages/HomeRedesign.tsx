          ...
          <div className="logo-marquee-wrapper">
            ...
            <div className="logo-marquee-track">
              ...
              <div className="logo-marquee-item">
                <svg viewBox="0 0 24 24" className="integration-logo google-calendar">
                  <path fill="#4285F4" d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12s4.48 10 10 10 10-4.48 10-10z"/>
                  <path fill="#fff" d="M12 6v6l4 2"/>
                  <rect fill="#EA4335" x="11" y="5" width="2" height="7" rx="1"/>
                  <rect fill="#EA4335" x="11" y="11" width="6" height="2" rx="1" transform="rotate(-30 14 12)"/>
                </svg>
                <span>Google Calendar</span>
              </div>

              <div className="logo-marquee-item">
                <svg viewBox="0 0 24 24" className="integration-logo microsoft">
              ...
              <div className="logo-marquee-item">
                <svg viewBox="0 0 24 24" className="integration-logo apple">
              ...
              <div className="logo-marquee-item">
                <svg viewBox="0 0 24 24" className="integration-logo salesforce">
                  <path fill="#00A1E0" d="M10.006 5.415a4.195 4.195 0 013.045-1.306c1.56 0 2.954.854 3.69 2.169a5.014 5.014 0 011.97-.404c2.79 0 5.052 2.262 5.052 5.05 0 2.79-2.262 5.052-5.051 5.052a5.02 5.02 0 01-1.17-.138 3.82 3.82 0 01-3.4 2.07c-.63 0-1.222-.152-1.746-.421a4.485 4.485 0 01-4.065 2.593c-2.088 0-3.87-1.424-4.378-3.354a4.26 4.26 0 01-.683.056c-2.354 0-4.263-1.91-4.263-4.263 0-1.665.954-3.107 2.345-3.808a4.43 4.43 0 01-.164-1.186c0-2.454 1.99-4.443 4.443-4.443 1.378 0 2.609.628 3.426 1.612z"/>
                </svg>
                <span>Salesforce</span>
              </div>

              <div className="logo-marquee-item">
                <svg viewBox="0 0 24 24" className="integration-logo hubspot">
                  <path fill="#FF7A59" d="M18.164 7.93V5.084a2.198 2.198 0 001.267-1.984 2.21 2.21 0 00-2.212-2.212 2.21 2.21 0 00-2.212 2.212c0 .873.51 1.627 1.248 1.984v2.846a5.056 5.056 0 00-2.32 1.152L6.398 3.71a2.62 2.62 0 00.072-.594A2.611 2.611 0 003.86.506 2.611 2.611 0 001.25 3.116a2.611 2.611 0 002.609 2.61c.48 0 .928-.13 1.313-.357l7.448 5.335a5.066 5.066 0 00-.397 1.96c0 .725.152 1.416.425 2.04l-2.27 2.271a2.1 2.1 0 00-.638-.103 2.136 2.136 0 00-2.136 2.136 2.136 2.136 0 002.136 2.135 2.136 2.136 0 002.135-2.135c0-.234-.038-.459-.108-.67l2.237-2.238a5.084 5.084 0 003.195 1.122 5.1 5.1 0 005.097-5.097 5.1 5.1 0 00-4.132-5.01zm-.945 7.72a2.707 2.707 0 01-2.704-2.704 2.707 2.707 0 012.704-2.704 2.707 2.707 0 012.703 2.704 2.707 2.707 0 01-2.703 2.703z"/>
                </svg>
                <span>HubSpot</span>
              </div>

              <div className="logo-marquee-item">
                <svg viewBox="0 0 24 24" className="integration-logo sap">
                  <path fill="#0FAAFF" d="M0 6.064v11.872h24V6.064H0zm12.226 9.47H10.45V9.09l-1.642 4.975h-.91L6.256 9.09v6.443H4.48V7.466h2.56l1.414 4.293 1.414-4.293h2.358v8.068zm4.098 0h-1.775V7.466h1.775v8.068zm4.098-6.293h-1.775v6.293h-1.775V9.241h-1.775V7.466h5.325v1.775z"/>
                </svg>
                <span>SAP</span>
              </div>

              <div className="logo-marquee-item">
                <svg viewBox="0 0 24 24" className="integration-logo openai">
                  <path fill="#10A37F" d="M22.282 9.821a5.985 5.985 0 00-.516-4.91 6.046 6.046 0 00-6.51-2.9A6.065 6.065 0 0012 .083c-2.13-.064-4.1 1.15-5.06 3.079a6.043 6.043 0 00-4.035 2.928 6.05 6.05 0 00.747 7.089 5.98 5.98 0 00.51 4.911 6.04 6.04 0 006.51 2.9A6.065 6.065 0 0012 23.917c2.13.064 4.1-1.15 5.06-3.079a6.043 6.043 0 004.035-2.928 6.05 6.05 0 00-.813-8.089zm-8.997 12.14c-1.234.017-2.427-.5-3.275-1.42.04-.022.11-.06.156-.087l5.434-3.138a.88.88 0 00.447-.765V9.93l2.296 1.327a.082.082 0 01.045.063v6.349c-.006 2.378-1.941 4.297-4.103 4.293zm-8.84-3.94a4.292 4.292 0 01-.514-2.887c.04.024.11.067.157.096l5.434 3.138a.88.88 0 00.894 0l6.635-3.83v2.652a.083.083 0 01-.033.07l-5.495 3.172a4.296 4.296 0 01-5.078-.611 4.26 4.26 0 01-2-1.8zM2.804 7.92a4.28 4.28 0 012.24-1.885c0 .046-.003.128-.003.185v6.275a.88.88 0 00.447.765l6.635 3.83-2.296 1.327a.082.082 0 01-.078.007l-5.494-3.173a4.294 4.294 0 01-1.451-5.331zm15.141 3.538l-6.635-3.83 2.296-1.326a.082.082 0 01.078-.007l5.494 3.172a4.296 4.296 0 01-.513 7.658V10.91a.876.876 0 00-.72-.452zm2.283-2.865c-.04-.023-.11-.066-.156-.095L14.638 5.36a.88.88 0 00-.894 0L7.109 9.19V6.538a.083.083 0 01.033-.07l5.494-3.172a4.294 4.294 0 016.447 4.447 4.28 4.28 0 01-.855 1.85zM6.297 11.89L4 10.564a.082.082 0 01-.045-.063v-6.35A4.294 4.294 0 018.17 0c1.22-.008 2.38.498 3.225 1.402-.04.022-.11.059-.156.087L5.805 4.626a.88.88 0 00-.447.765l-.06 6.5zm1.247-2.207l2.953-1.706 2.954 1.706v3.41l-2.954 1.706-2.953-1.706v-3.41z"/>
                </svg>
                <span>OpenAI</span>
              </div>
