          ...
          <div className="logo-marquee-wrapper">
            ...
            <div className="logo-marquee-track">
              ...
              <div className="logo-marquee-item">
                <svg viewBox="0 0 200 200" className="integration-logo">
                  <path fill="#fff" d="M152.637 47.363H47.363v105.274h105.274z"/>
                  <path fill="#1A73E8" d="M152.637 200L200 152.637V47.363L152.637 0z"/>
                  <path fill="#EA4335" d="M47.363 200L0 152.637h47.363z"/>
                  <path fill="#34A853" d="M200 47.363L152.637 0H47.363L0 47.363z"/>
                  <path fill="#188038" d="M0 47.363v105.274L47.363 200V47.363z"/>
                  <path fill="#FBBC04" d="M200 152.637V47.363h-47.363v105.274z"/>
                  <path fill="#1967D2" d="M152.637 152.637H47.363V200h105.274z"/>
                  <g fill="#1A73E8">
                    <path d="M77.091 126.182c-3.818-2.582-6.473-6.4-7.927-11.345l8.873-3.673c.8 3.055 2.255 5.455 4.327 7.127 2.073 1.673 4.582 2.51 7.455 2.51 2.946 0 5.491-.909 7.673-2.727 2.182-1.818 3.273-4.109 3.273-6.873 0-2.836-1.164-5.164-3.491-6.982-2.327-1.818-5.2-2.727-8.618-2.727h-5.346v-8.727h4.8c2.982 0 5.491-.8 7.527-2.4 2.036-1.6 3.055-3.709 3.055-6.327 0-2.4-.909-4.327-2.727-5.782-1.818-1.454-4.109-2.182-6.873-2.182-2.691 0-4.836.691-6.436 2.073-1.6 1.382-2.764 3.055-3.491 5.018l-8.727-3.636c1.236-3.418 3.527-6.4 6.873-8.945 3.345-2.545 7.527-3.818 12.545-3.818 3.709 0 7.055.727 10.036 2.182s5.309 3.491 6.982 6.109c1.673 2.618 2.509 5.564 2.509 8.836 0 3.345-.8 6.182-2.4 8.509-1.6 2.327-3.564 4.073-5.891 5.236v.545c2.982 1.236 5.418 3.2 7.309 5.891 1.891 2.691 2.836 5.891 2.836 9.6 0 3.636-.945 6.909-2.836 9.818-1.891 2.909-4.509 5.2-7.855 6.873-3.345 1.673-7.127 2.509-11.345 2.509-5.236 0-9.818-1.309-13.636-3.891zM141.091 78.545l-9.764 7.055-4.582-6.982 17.018-12.254h6.327v60.509h-9.018V78.545z"/>
                  </g>
                </svg>
              ...
              <div className="logo-marquee-item">
                <svg viewBox="0 0 92.7 46" className="integration-logo">
                  <path fill="#0070AD" d="M0 46h46.2L55.5 0H9.3L0 46z"/>
                  <path fill="#FFFFFF" d="M19.5 34.8c-.7 0-1.5-.1-2.2-.2l.4-3.6c.7.2 1.3.3 1.9.3 1.5 0 2-.7 2.2-2l1.9-13.8h-4.4l.5-3.6h8.7L26 27.3c-.5 3.8-2.3 7.5-6.5 7.5zm12.9-.2l2.5-18.4h-4.4l.5-3.6h4.4l.3-2.4c.5-3.7 2.4-7.4 6.9-7.4.8 0 1.8.1 2.6.4l-.5 3.6c-.5-.1-1-.2-1.5-.2-1.8 0-2.4 1.3-2.7 3.2l-.2 2.8h3.8l-.5 3.6h-3.8L37 34.6h-4.6z"/>
                  <path fill="#0070AD" d="M92.7 46H46.5L37.2 0h46.2l9.3 46z"/>
                  <path fill="#FFFFFF" d="M60.2 34.8c-4.9 0-8.1-2.9-8.1-8.3 0-6.6 4.4-14.3 12-14.3 4.9 0 8.1 2.9 8.1 8.3-.1 6.6-4.5 14.3-12 14.3zm3-18.9c-3.9 0-6.8 5-6.8 9.9 0 2.8 1.3 5.3 4.4 5.3 3.9 0 6.8-5 6.8-9.9.1-2.8-1.2-5.3-4.4-5.3zm23.3 18.7l1.9-14c.2-1.3.3-2.6.4-3.7h-4.5l-.2 2.3c-.9-1.7-2.6-2.6-4.7-2.6-5.7 0-9.3 6.1-9.3 12.1 0 4.3 2.2 7.6 6.4 7.6 2.2 0 4.2-.9 5.7-2.8l-.3 2.4h4.6v-1.3zm-5.9-3.8c-2.2 0-3.4-1.7-3.4-4.2 0-3.4 1.9-7.5 5.4-7.5 2.2 0 3.4 1.7 3.4 4.2 0 3.5-2 7.5-5.4 7.5z"/>
                </svg>
                <span>SAP</span>
              </div>
