              ...
              <AnimatePresence mode="wait">
                ...
                {activeTab === 'analysis' && (
                  ...
                  >
                    ...
                    {/* V1 Legal Pulse Analyse-Karte — ENTFERNT (22.04.2026)
                       V2 Pipeline hat V1 vollständig ersetzt. Die Karte zeigte
                       automatisch generierte V1-Daten die User verwirrt haben.
