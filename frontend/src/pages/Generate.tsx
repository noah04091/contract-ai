...
const CONTRACT_TYPES: ContractType[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'compensation', label: 'Vergütung / Gegenleistung', type: 'text', placeholder: 'z.B. 10.000€, monatlich 500€, oder tauschbasiert', required: false, group: 'Konditionen' },
      ...
      { name: 'details', label: 'Weitere Details und Sonderwünsche', type: 'textarea', placeholder: 'Alle zusätzlichen Regelungen, Besonderheiten, Klauseln die der Vertrag enthalten soll...', required: false, group: 'Besonderes', helpText: 'Je detaillierter Ihre Angaben, desto besser das Ergebnis' },
      { name: 'governingLaw', label: 'Anwendbares Recht', type: 'select', placeholder: 'Welches Recht gilt?', required: true, group: 'Rechtliches',
        options: ['Deutsches Recht', 'Österreichisches Recht', 'Schweizer Recht'] },
