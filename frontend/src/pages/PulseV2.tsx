...
const DashboardView: React.FC<{ onSelectContract: (id: string, alertId?: string) => void }> = ({ onSelectContract }) => {
  ...
  const [monitoringStatus, setMonitoringStatus] = useState<{ status: 'green' | 'yellow' | 'red' | 'neutral'; statusLabel: string; contractsMonitored: number; lastScan: string | null; lastScheduledScan: string | null; lastRadarScan: string | null; lastRadarRun: string | null; nextMonitorScan: string; nextRadarScan: string; pulseAccess?: boolean; alertsTotal: number; severityCounts: { critical: number; high: number; medium: number; low: number }; recentAlertsCount: number } | null>(null);
